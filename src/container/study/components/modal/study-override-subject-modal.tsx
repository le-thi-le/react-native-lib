...
export type OverrideModalProps = ComponentProps;
const OverrideModal: React.FunctionComponent<OverrideModalProps> = (props) => {
        ...
        <View style={styles.viewBox}>
          ...
          <View style={styles.viewBtnSave}>
            ...
            <TouchableOpacity
              ...
              <Text style={styles.txtTitleBtnCancel}>CANCEL</Text>
            </TouchableOpacity>
          </View>
        </View>
      </Modal>
